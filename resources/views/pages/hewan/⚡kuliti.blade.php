...
new #[Layout('layouts.dashboard')] #[Title('Kuliti')] class extends Component {
    ...
    public function statusLabel(Hewan $hewan): string
    {
        ...
        if ($hewan->mulai_kuliti !== null) {
            return $hewan->mulai_kuliti->format('H:i:s');
        }
        ...
        @forelse ($hewanItems as $hewan)
            <article class="space-y-3 rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="flex items-center justify-between gap-2">
                    ...
                    <flux:text class="font-medium">{{ $this->durationLabel($hewan->mulai_kuliti, $hewan->selesai_kuliti) }}</flux:text>
                </div>
            ...
            <flux:table.rows>
                @forelse ($hewanItems as $hewan)
                    <flux:table.row :key="'kuliti-hewan-'.$hewan->id">
                        ...
                        <flux:table.cell>{{ $this->durationLabel($hewan->mulai_kuliti, $hewan->selesai_kuliti) }}</flux:table.cell>
                        <flux:table.cell>
                            @if ($hewan->mulai_kuliti === null)
